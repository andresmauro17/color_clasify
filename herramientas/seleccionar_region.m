...
% varargin   command line arguments to seleccionar_region (see VARARGIN)

% Choose default command line output for seleccionar_region
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);
% set(handles.capa1,'value',0);
% set(handles.capa2,'value',0);
% set(handles.capa3,'value',0);
% set(handles.capa4,'value',0);
...
% hObject    handle to boton_volver_a_regiones (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
capas
...
% hObject    handle to boton_volver_a_inicio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
prueba_rgb
